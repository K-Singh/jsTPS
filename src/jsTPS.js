   ...
   isPerformingDo() {
    ...
    doTransaction() {
        if (hasTransactionToRedo()) {
            performingDo = true;
            var transaction = transactions.get(mostRecentTransaction+1);
    ...
    undoTransaction() {
        if (hasTransactionToUndo()) {
            performingUndo = true;
            var transaction = transactions.get(mostRecentTransaction);
